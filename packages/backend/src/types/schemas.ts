...
export const transactionSchema = z.object({
  ...
  installmentPlanId: z.string().cuid().nullable().optional(),
...
export const billSchema = z.object({
  ...
  userId: z.string().cuid(),
  accountId: z.string().cuid().nullable().optional(),
  recurringBillId: z.string().cuid().nullable().optional(),
  description: z.string().min(1).max(200),
  amountCents: z.number().int(),
  categoryId: z.string().cuid().nullable().optional(),
  dueDate: z.string().datetime(),
...
export const sharedDebtSchema = z.object({
  ...
  debtorUserId: z.string().cuid(),
  creditorUserId: z.string().cuid(),
